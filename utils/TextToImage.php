...
/**
 * Source: https://www.codexworld.com/convert-text-to-image-php/
 */
...
class TextToImage
{
     ...
     */
    function createImage($text, $fontSize = 40, $imgWidth = 400, $imgHeight = 200)
    {
        ...
        imagefilledrectangle($this->img, 0, 0, $imgWidth - 1, $imgHeight - 1, $grey);
